...
public class RestaurantController {
    ...
    private RestaurantDTO convertToDto(Restaurant restaurant) {
        ...
        if (restaurant.getMenuItems() != null) {
            dto.setItems(restaurant.getMenuItems().stream()
    ...
    private MenuItemDTO convertMenuItemToDto(com.foodordering.restaurant.models.MenuItem menuItem) {
        ...
        dto.setDiscount(menuItem.getDiscount());
        return dto;
    }
}