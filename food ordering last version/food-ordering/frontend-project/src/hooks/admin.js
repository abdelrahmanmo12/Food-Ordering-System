/**
 * Admin Hooks - React Query wrappers for admin APIs
 * 
 * Based on OpenAPI spec endpoints:
 * - GET /auth/accounts/pending
 * - PUT /auth/accounts/{id}/status
 * - GET /restaurants/admin/requests
 * - PATCH /restaurants/admin/requests/{id}/status
 * 
 * Also includes existing hooks for restaurant-owner management.
 */
